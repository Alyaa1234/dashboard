        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
          {earningData.map((item)=>(
            ...
            >
              ...
              <p className='mt-3'>
                <span className='text-lg font-simibold'>
                  {item.amount}
                </span>
          ...
          <div className='bg-white dark:text-gray-200  dark:bg-secondary-dark-bg m-3 p-4 rouded-2xl md:w-780  '>
            ...
            <div className="mt-10 flex gap flex-wrap justify-center">
                <div className="border-r-1  border-color m-4 pr-10">
                  ...
                  <div>
                    <p>
                      <span className="text-3xl font-simibold ">$93,438</span>
                      <span className="p-1.5 ml-3 hover:drop-shadow-xl cursor-pointer rounded-full bg-green-400 text-white text-xs">23%</span>
                    </p>
                  ...
                  <div className='mt-8'>
                    <p>
                      <span className="text-3xl font-simibold ">$48,438</span>
                    </p>
                    <p className='text-gray-500 mt-1'>
                      Expense
                    </p>
